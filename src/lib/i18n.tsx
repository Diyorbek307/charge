...
const DICT = {
  ...
  // ── Dashboard sub-captions ──
  'sub.15VsAug': { ru: '+15% к авг.', uz: '+15% avg. ga nisbatan', en: '+15% vs Aug' },
  'sub.18VsLastWeek': { ru: '+18% к прошлой неделе', uz: '+18% o‘tgan haftaga nisbatan', en: '+18% vs last week' },
  'sub.19VsAug': { ru: '+19% vs авг.', uz: '+19% avg. ga nisbatan', en: '+19% vs Aug' },
  'sub.47VsAug': { ru: '+4.7% к авг', uz: '+4.7% avg. ga nisbatan', en: '+4.7% vs Aug' },
  'sub.42ThisWeek': { ru: '+42 этой неделе', uz: '+42 shu haftada', en: '+42 this week' },
  'sub.420ThisWeek': { ru: '+420 этой неделе', uz: '+420 shu haftada', en: '+420 this week' },
  'sub.005OfTotal': { ru: '0.05% от общего', uz: 'umumiydan 0.05%', en: '0.05% of total' },
  'sub.2NearLimit': { ru: '2 у лимита', uz: '2 tasi limitga yaqin', en: '2 near limit' },
  'sub.3Active': { ru: '3 активных', uz: '3 ta faol', en: '3 active' },
  'sub.3Invoices': { ru: '3 инвойса', uz: '3 ta hisob-faktura', en: '3 invoices' },
  'sub.3Deducted': { ru: '3% · вычтено', uz: '3% · ushlab qolindi', en: '3% · deducted' },
  'sub.38ActiveNow': { ru: '38 активны сейчас', uz: '38 tasi hozir faol', en: '38 active now' },
  'sub.4Active': { ru: '4 активны', uz: '4 tasi faol', en: '4 active' },
  'sub.4Active2': { ru: '4 активных', uz: '4 ta faol', en: '4 active' },
  'sub.4Operators': { ru: '4 оператора', uz: '4 ta operator', en: '4 operators' },
  'sub.5546400Uzs': { ru: '5 546 400 сум', uz: '5 546 400 so‘m', en: '5,546,400 UZS' },
  'sub.96Online': { ru: '96 онлайн', uz: '96 tasi onlayn', en: '96 online' },
  'sub.apiOcpiWebhooks': { ru: 'API, OCPI, вебхуки', uz: 'API, OCPI, vebxuklar', en: 'API, OCPI, webhooks' },
  'sub.apiOcpiGuides': { ru: 'API, OCPI, руководства', uz: 'API, OCPI, qo‘llanmalar', en: 'API, OCPI, guides' },
  'sub.cdrValidationFraudCheck': { ru: 'CDR валидация, fraud check', uz: 'CDR tekshiruvi, fraud check', en: 'CDR validation, fraud check' },
  'sub.operatorIban': { ru: 'IBAN оператора', uz: 'Operator IBAN', en: 'Operator IBAN' },
  'sub.pushOnEveryNewCharge': { ru: 'Push при каждой новой зарядке', uz: 'Har bir yangi zaryadda push', en: 'Push on every new charge' },
  'sub.31Average': { ru: '~3.1% средняя', uz: '~3.1% o‘rtacha', en: '~3.1% average' },
  'sub.videoLessonsAndWebinars': { ru: 'Видеоуроки и вебинары', uz: 'Video darslar va vebinarlar', en: 'Video lessons and webinars' },
  'sub.weeklySummary': { ru: 'Еженедельная сводка', uz: 'Haftalik xulosa', en: 'Weekly summary' },
  'sub.weeklyInvoiceByEmail': { ru: 'Еженедельный инвойс на email', uz: 'Emailga haftalik hisob-faktura', en: 'Weekly invoice by email' },
  'sub.connectionRequests': { ru: 'Заявки на подключение', uz: 'Ulanish arizalari', en: 'Connection requests' },
  'sub.sessionSummaryReport': { ru: 'Итоговый отчёт по сессии', uz: 'Seans bo‘yicha yakuniy hisobot', en: 'Session summary report' },
  'sub.whenAnEmployeeHasUsed80OfTheLimit': { ru: 'Когда сотрудник использовал 80% лимита', uz: 'Xodim limitning 80% ini ishlatganda', en: 'When an employee has used 80% of the limit' },
  'sub.platformUpdates': { ru: 'Обновления платформы', uz: 'Platforma yangilanishlari', en: 'Platform updates' },
  'sub.online247': { ru: 'Онлайн 24/7', uz: 'Onlayn 24/7', en: 'Online 24/7' },
  'sub.userPayment': { ru: 'Оплата пользователя', uz: 'Foydalanuvchi to‘lovi', en: 'User payment' },
  'sub.replyWithin2Hours': { ru: 'Ответ в течение 2 часов', uz: '2 soat ichida javob', en: 'Reply within 2 hours' },
  'sub.cdrValidationErrors': { ru: 'Ошибки валидации CDR', uz: 'CDR tekshiruv xatolari', en: 'CDR validation errors' },
  'sub.errorsAndRefunds': { ru: 'Ошибки и возвраты', uz: 'Xatolar va qaytarishlar', en: 'Errors and refunds' },
  'sub.monFri9001800': { ru: 'Пн–Пт 9:00–18:00', uz: 'Du–Ju 9:00–18:00', en: 'Mon–Fri 9:00–18:00' },
  'sub.suspiciousOperations': { ru: 'Подозрительные операции', uz: 'Shubhali operatsiyalar', en: 'Suspicious operations' },
  'sub.suggestAnImprovement': { ru: 'Предложить улучшение', uz: 'Yaxshilashni taklif qilish', en: 'Suggest an improvement' },
  'sub.limitExhaustionWarning': { ru: 'Предупреждение об исчерпании лимита', uz: 'Limit tugashi haqida ogohlantirish', en: 'Limit exhaustion warning' },
  'sub.whenAUserIsAdded': { ru: 'При добавлении пользователя', uz: 'Foydalanuvchi qo‘shilganda', en: 'When a user is added' },
  'sub.reportAProblem': { ru: 'Сообщить о проблеме', uz: 'Muammo haqida xabar berish', en: 'Report a problem' },
  'sub.invoiceGeneration': { ru: 'Формирование инвойса', uz: 'Hisob-faktura shakllantirish', en: 'Invoice generation' },
  'sub.withinAMonth': { ru: 'в течение месяца', uz: 'bir oy davomida', en: 'within a month' },
  'sub.allPlatforms': { ru: 'все платформы', uz: 'barcha platformalar', en: 'all platforms' },
  'sub.date9Sep2026': { ru: 'дата: 9 сент 2026', uz: 'sana: 9 sen 2026', en: 'date: 9 Sep 2026' },
  'sub.until07092026': { ru: 'до 07.09.2026', uz: '07.09.2026 gacha', en: 'until 07.09.2026' },
  'sub.availability': { ru: 'доступность', uz: 'mavjudlik', en: 'availability' },
  'sub.forSeptember': { ru: 'за сентябрь', uz: 'sentyabr uchun', en: 'for September' },
  'sub.perSession': { ru: 'за сессию', uz: 'seans uchun', en: 'per session' },
  'sub.pays': { ru: 'оплачивает', uz: 'to‘laydi', en: 'pays' },
  'sub.ofLimit': { ru: 'от лимита', uz: 'limitdan', en: 'of limit' },
  'sub.covered': { ru: 'охвачено', uz: 'qamrab olingan', en: 'covered' },
  'sub.acrossTheFleet': { ru: 'по всему парку', uz: 'butun avtopark bo‘yicha', en: 'across the fleet' },
  'sub.fromCustomerReviews': { ru: 'по отзывам клиентов', uz: 'mijozlar sharhlari bo‘yicha', en: 'from customer reviews' },
  'sub.acrossTheNetwork': { ru: 'по сети', uz: 'tarmoq bo‘yicha', en: 'across the network' },
  'sub.verifiedPhones': { ru: 'подтверждённые телефоны', uz: 'tasdiqlangan telefonlar', en: 'verified phones' },
  'sub.receivesD2': { ru: 'получает D+2', uz: 'D+2 da oladi', en: 'receives D+2' },
  'sub.limitOverruns': { ru: 'превышение лимитов', uz: 'limitdan oshish', en: 'limit overruns' },
  'sub.atTheCurrentTrend': { ru: 'при текущей динамике', uz: 'joriy dinamikada', en: 'at the current trend' },
  'sub.withCorporateLimit': { ru: 'с корп. лимитом', uz: 'korp. limit bilan', en: 'with corporate limit' },
  'sub.september': { ru: 'сентябрь', uz: 'sentyabr', en: 'September' },
  'sub.avg325': { ru: 'средн. 3.25%', uz: 'o‘rt. 3.25%', en: 'avg 3.25%' },
  'sub.averageLatency': { ru: 'средняя задержка', uz: 'o‘rtacha kechikish', en: 'average latency' },
  'sub.stationsOnline': { ru: 'станций онлайн', uz: 'stansiya onlayn', en: 'stations online' },
  'sub.uzsKwh': { ru: 'сум / кВт·ч', uz: 'so‘m / kVt·s', en: 'UZS / kWh' },
  'sub.uzsWholeFleet': { ru: 'сум · весь парк', uz: 'so‘m · butun avtopark', en: 'UZS · whole fleet' },
  'sub.currentTraffic': { ru: 'текущий трафик', uz: 'joriy trafik', en: 'current traffic' },
  'sub.tonnes100gCoKm': { ru: 'тонн × 100г CO₂/км', uz: 'tonna × 100g CO₂/km', en: 'tonnes × 100g CO₂/km' },
  'sub.needAttention': { ru: 'требуют внимания', uz: 'e’tibor talab qiladi', en: 'need attention' },
  'sub.needReview': { ru: 'требуют проверки', uz: 'tekshiruv talab qiladi', en: 'need review' },
